...
class MAIN:
    ...
    def draw_score(self):
        ...
        pygame.draw.rect(screen, (224, 255, 181), bg_rect, 2)

    def draw_game_over(self):
        game_over_text = str(f'GAME OVER\nSCORE: {len(self.snake.body) - 3}')
        ...
        pygame.draw.rect(screen, (167, 209, 61), game_over_rect)
...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            block_rect = pygame.rect.Rect(x_pos, y_pos, cell_size, cell_size)
